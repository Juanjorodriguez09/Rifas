...
export default function NumberCell({ number, isWinner, onClick }: Props) {
  return (
    <button
      ...
      className={`group relative aspect-square rounded-full border-2 flex items-center justify-center font-bold transition-transform hover:scale-105 active:scale-95 ${statusStyles[number.status]} ${
